...
const BlogBannerUpdate = ({blog}) => {
    ...
    const onSubmit = data => {
        ...
        fetch(`https://dev-next-gen-server.vercel.app/blogbanner/${_id}`, {
            method: 'PUT',
            headers: {
    ...
    return (
        <div className="py-10">
            <div className="">
                <TitleSubTitle Title="Blog Banner" ></TitleSubTitle>
                <div className="card w-full cardbg shadow-xl">
                    <div className="justify-center p-16  items-center text-center">
                        <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <button className="gradient-bg btn  w-full border-0 ">Update Blog </button>
                        </form>
                    </div>
                </div>
            </div>
...
export default BlogBannerUpdate;